...
import { useGetExpiredMedicinesQuery } from "../../features/api/apiSlice";
    ...
    return (
      <div className="flex w-full h-full items-center justify-center">
        ...
        >
          ...
          <span className="font-medium"> Sorry it will take much long... </span>
        </button>
      </div>
    );
  }
